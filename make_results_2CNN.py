...
samples = np.load("cnn/2-cyanonaphthalene/analyzed_chain.npy").T
samples[4:8,:] *= 1e11
...
f= open("2CNN_formatted_results.txt","w+")
...
f= open("2CNN_results.txt","w+")

f.write("2CNN_hfs.cat\n")
